# swisscom_billingprofiles_javascript_sdk

SwisscomBillingprofilesJavascriptSdk - JavaScript client for swisscom_billingprofiles_javascript_sdk
No descripton provided (generated by Swagger Codegen https://github.com/swagger-api/swagger-codegen)
This SDK is automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project:

- API version: 1.0
- Package version: 1.0.21
- Build date: 2017-04-25T11:50:32.385+02:00
...
```shell
npm install swisscom_billingprofiles_javascript_sdk --save
```
...
var defaultClient = SwisscomBillingprofilesJavascriptSdk.ApiClient.instance;
...
var api = new SwisscomBillingprofilesJavascriptSdk.DefaultApi()
...
------------ | ------------- | ------------- | -------------
*SwisscomBillingprofilesJavascriptSdk.DefaultApi* | [**gETBillingprofiles**](docs/DefaultApi.md#gETBillingprofiles) | **GET** /billingprofiles | 
*SwisscomBillingprofilesJavascriptSdk.DefaultApi* | [**gETBillingprofilesBillingProfileId**](docs/DefaultApi.md#gETBillingprofilesBillingProfileId) | **GET** /billingprofiles/{billingProfileId} | 
*SwisscomBillingprofilesJavascriptSdk.DefaultApi* | [**gETBillingprofilesBillingProfileIdEligibility**](docs/DefaultApi.md#gETBillingprofilesBillingProfileIdEligibility) | **GET** /billingprofiles/{billingProfileId}/eligibility | 


## Documentation for Models

 - [SwisscomBillingprofilesJavascriptSdk.BillingProfileDetails](docs/BillingProfileDetails.md)
 - [SwisscomBillingprofilesJavascriptSdk.BillingProfileEligibility](docs/BillingProfileEligibility.md)
 - [SwisscomBillingprofilesJavascriptSdk.BillingProfilesCollection](docs/BillingProfilesCollection.md)
 - [SwisscomBillingprofilesJavascriptSdk.BillingProfilesCollectionInner](docs/BillingProfilesCollectionInner.md)
 - [SwisscomBillingprofilesJavascriptSdk.BillingProfilesCollectionInnerLinks](docs/BillingProfilesCollectionInnerLinks.md)
 - [SwisscomBillingprofilesJavascriptSdk.CustomerAddress](docs/CustomerAddress.md)
 - [SwisscomBillingprofilesJavascriptSdk.CustomerAddressInner](docs/CustomerAddressInner.md)
 - [SwisscomBillingprofilesJavascriptSdk.Error](docs/Error.md)
